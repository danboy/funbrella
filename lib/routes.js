...
module.exports = function(app, routes) {
  ...
  app.put('/boards/:id', routes.Board.update);
  ...
  app.get('/widgets', routes.Widget.index);
  app.get('/widgets/:id', routes.Widget.show);
  app.put('/widgets', routes.Widget.update)
  app.put('/widgets/:id', routes.Widget.update)
  app.post('/widgets', routes.Widget.create)
}
